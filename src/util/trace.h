...
#define ptrace_set_reg_u64(pid, offset, value) ptrace(PTRACE_POKEUSER, (pid), (offset), (value))
#define ptrace_get_reg_u64(pid, offset) ptrace(PTRACE_PEEKUSER, (pid), (offset), NULL)
